package com.github.madzdns.cluster.core.wsi;
...
import com.github.madzdns.cluster.core.backend.ResourceCtrl;
import com.github.madzdns.cluster.core.backend.ZoneSynch;
import com.github.madzdns.cluster.core.backend.frsynch.StartupManager;
import com.github.madzdns.cluster.core.backend.frsynch.ZoneSynchCallback;
import com.github.madzdns.cluster.core.backend.frsynch.ZoneSynchMessage;
...
import com.github.madzdns.cluster.core.wsi.model.EdgeModel;
...
import com.github.madzdns.cluster.core.api.FRfra;
import com.github.madzdns.cluster.core.api.Resolver;
import com.github.madzdns.cluster.core.backend.frsynch.Frsynch;
import com.github.madzdns.cluster.core.backend.kafka.KafkaTopics;
import com.github.madzdns.cluster.core.backend.kafka.codec.ClusterMessage;
import com.github.madzdns.cluster.core.backend.kafka.codec.ResourceMessage;
import com.github.madzdns.cluster.core.backend.kafka.producer.KafkaProducerImpl;
import com.github.madzdns.cluster.http.web.WebController;
    ...
    public String postCluserInfo(@RequestParam(name = "id") short id,
        ...
        for (int i = 0; i < edges.size(); i++) {
            ...
            if (e.getClusterAddrz() != null) {
                ...
                for (Iterator<EdgeModel.AddressPort> it = e.getClusterAddrz().iterator(); it.hasNext(); ) {
                    EdgeModel.AddressPort ap = it.next();
            ...
            if (e.getBackendAddrz() != null) {
                ...
                for (Iterator<EdgeModel.AddressPort> it = e.getBackendAddrz().iterator(); it.hasNext(); ) {
            ...
            ClusterNode edge = new ClusterNode(e.getId(),
                    ...
                    null, e.getState() ? ClusterNode.STATE_VLD : ClusterNode.STATE_DEL,
                    e.getMonitorDelay(),
