package com.github.madzdns.cluster.rtp.rtcp;
...
import com.github.madzdns.cluster.rtp.Packet;
/**
...
public class RTCPPacket implements Packet {
	...
	/** varies by packet clientBackend */
	protected byte count;

	/** RTCP packet clientBackend */
	...
	{
		packetType = new UnsignedByte(type);
	}
	public void setPacketVersion(short ver)
	{
		version = (byte) ver;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see rtspproxy.Packet#toIoBuffer()
	 */
