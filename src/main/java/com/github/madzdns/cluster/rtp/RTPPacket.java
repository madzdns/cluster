package com.github.madzdns.cluster.rtp;
...
public class RTPPacket implements Packet {
	...
	public static UnsignedByte unsignedByteFromInt(int num) {
		
		return new UnsignedByte(num);
	}
	
	public static UnsignedShort unsignedShortFromInt(int num) {
		
		return new UnsignedShort(num);
	}
	
	public static UnsignedInt unsignedIntFromLong(long num) {
		
		return new UnsignedInt(num);
	}
	 ...
	 * clientBackend field (see Section 5.3).
	 */
	 ...
	 * mapping of payload clientBackend codes to payload formats. Additional payload clientBackend
	 ...
	 * companion RFC 3551 [1]. An RTP source MAY change the payload clientBackend during
	 ...
	 * that does.
	 */
	private UnsignedShort sequence = new UnsignedShort(0);
	 ...
	 */
	private UnsignedInt timestamp = new UnsignedInt(0);
	 ...
	 */
	private UnsignedInt ssrc = new UnsignedInt(0);
	...
	private short profileExtension = 0;
	...
	public int getHeaderLen() {
		...
		int headerSize = 12 + csrc.length * 4 + payload.length;
		
		if (extension)
			
			headerSize += headerExtension.length;
	...
	public IoBuffer toIoBuffer() {
		...
		buffer.putShort(sequence.shortValue());
