...
import com.github.madzdns.server.app.AppConfig;
import com.github.madzdns.server.core.Server;
...
import com.github.madzdns.server.core.config.entry.dns.ETxt;
import com.github.madzdns.server.core.config.entry.dns.EntryDns;
...
public class Config {
    ...
    public static String KAFKA_CONFIG_PATH = "core.properties";
    ...
    public static String ORIGIN_REFERRER;
    ...
    private static void configStaticGlobals(String root) throws MalformedURLException {
    ...
    private static void configDynamicGlobals() throws MalformedURLException {
        REFERRER = Config.getApp().getApiPrefix()+"_referrer";
        ORIGIN_REFERRER = Config.getApp().getApiPrefix()+"_origin_referrer";
    }
    ...
    public static App getApp() {
        ...
        String confPath = getRoot() + File.separator + APP_CONF;
        JAXBContext jc = null;
        try {
