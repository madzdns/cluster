...
import com.github.madzdns.server.rtp.handler.RtpTransportHandler;
...
public class RTSPNegotiation {
	...
	private final static String DEFULT_PROTO = "com/github/madzdns/x/rtsp";
	...
	private final static String FORWARD_STATUS_KEY = RTSPNegotiation.class.getName()+"core stae";
