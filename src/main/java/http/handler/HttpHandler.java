...
import http.HTTPMessage.Method;
...
import rtmpt.RTMPTConnectionMinaFilter;
...
import server.backend.node.dynamic.ResolveHintType;
...
import server.core.http.HttpProxy;
import server.core.http.ProxyResponse;
...
public class HttpHandler extends IoHandlerAdapter {
	...
	private final static String DEFULT_PROTO = "http";
						...
						if(refer!= null && !refer.equals("")) {
							...
							if(redirect.indexOf("?") != -1) {
								...
								redirect = new StringBuilder(redirect)
									.append("&")
									.append(FRfra.ORIGIN_REFERRER).append("=")
